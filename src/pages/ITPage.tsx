      ...
      <main className="p-8 max-w-5xl mx-auto">
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 mb-6 shadow-xl">
          <p className="mb-4">
            ...
            programmeringsspråk og velge og anvende relevante programmeringsspråk
            og algoritmer i eget arbeid"
          </p>
          <p className="mb-4">
          ...
          <p>
            ...
            videoen (legg alt i body-taggen i html-dokumentet ditt og åpne konsoll
            i browser med Chrome: fn+f12, Opera: ctrl+shift+c):
          </p>
        </div>
